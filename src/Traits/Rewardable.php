...
namespace ClickerTech\Promocodes\Traits;

use Carbon\Carbon;
use ClickerTech\Promocodes\Models\Promocode;
use ClickerTech\Promocodes\Facades\Promocodes;
use ClickerTech\Promocodes\Exceptions\AlreadyUsedException;
...
trait Rewardable
{
     ...
     *
     * @return null|\ClickerTech\Promocodes\Models\Promocode
     ...
     * @param null|\Closure $callback
     *
     * @return bool|null|\ClickerTech\Promocodes\Models\Promocode
     * @throws AlreadyUsedException
     */
